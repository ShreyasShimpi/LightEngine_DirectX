...
{
	float3 textureColor = materialColor;
	...
	float pointLightAttenuationFactor = 1.0f / (
	pointLightAttenuation.x +
	...
	// total diffuse light
	float3 diffuseLight = directionLightDiffuseStrength + pointLightAttenuationFactor * pointLightDiffuse;

	// total light
	float3 totalLight = ambientLight + diffuseLight;
